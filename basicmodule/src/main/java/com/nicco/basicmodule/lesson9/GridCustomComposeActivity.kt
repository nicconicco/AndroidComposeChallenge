package com.nicco.basicmodule.lesson9
...
import androidx.compose.ui.unit.dp
import com.nicco.basicmodule.lesson9.ui.theme.ComposePathwayCuritibaTheme
import com.nicco.basicmodule.lesson9.ui.theme.purple200

class GridCustomComposeActivity : AppCompatActivity() {
...
fun Greeting2(name: String) {
    Box(
        ...
        Column(Modifier.align(Alignment.TopCenter)) {
            Text(text = "Hello1 $name!", modifier = Modifier.padding(10.dp))
        }
